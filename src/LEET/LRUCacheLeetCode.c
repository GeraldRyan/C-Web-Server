...
#define test_data external_data
...
int main(void)
{
  printf("Data from other file %d %d %d %d %d %d \n\n", external_data[0][0],external_data[1][0],external_data[1][1],external_data[2][0],external_data[2][1],external_data[3][0]);
